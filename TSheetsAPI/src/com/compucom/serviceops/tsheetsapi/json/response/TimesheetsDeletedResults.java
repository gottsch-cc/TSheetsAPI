 ...
 *
 */
public class TimesheetsDeletedResults implements IResults {
	@SerializedName("timesheets_deleted") private Map<String, TimesheetJson> timesheets;
	...
	public String toString() {
		return "TimesheetsDeletedResults [timesheets=" + timesheets + "]";
	}
}
